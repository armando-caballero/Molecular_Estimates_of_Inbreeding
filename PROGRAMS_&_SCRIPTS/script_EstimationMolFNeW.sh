...
cp ../../COMPILING_FILES/plink1.9 /state/partition1/EstMolNe$n/$SLURM_JOBID/
...
cp shell_F_roh /state/partition1/EstMolNe$n/$SLURM_JOBID/shell_F_roh
...
echo "gen ind  QT   Fibd      Fped     Fvr1      Fvr2BP    Fyang1    Fyang2    FLH1     FLH2     Fhom     FR100    FR1000   FR5000" > kk1
mv list_individual_Fs kk2
cat kk1 kk2 > list_individual_Fs
echo "gen ind  QT   Fibd     Fped     Fvr1BP   Fvr2BP   Fyang1BP Fyang2BP FLH1BP   FLH2BP   FhomBP     FR100    FR1000   FR5000" > kk3
mv list_individual_FsBP kk4
cat kk3 kk4 > list_individual_FsBP
...
cp -r /state/partition1/EstMolNe$n/$SLURM_JOBID/data.F $WDIR/RESULTS.T$TNIND.N$NIND.$n/
cp -r /state/partition1/EstMolNe$n/$SLURM_JOBID/data.map $WDIR/RESULTS.T$TNIND.N$NIND.$n/
cp -r /state/partition1/EstMolNe$n/$SLURM_JOBID/data.ped $WDIR/RESULTS.T$TNIND.N$NIND.$n/
cp -r /state/partition1/EstMolNe$n/$SLURM_JOBID/data.log $WDIR/RESULTS.T$TNIND.N$NIND.$n/
cp -r /state/partition1/EstMolNe$n/$SLURM_JOBID/data.hom* $WDIR/RESULTS.T$TNIND.N$NIND.$n/
